...
namespace CodeJam.Ranges
{
        ...
        where TValue : IComparable<TValue>
    {
        ...
        private int CalculateHashCode()
        {
            ...
            for (int i = 0; i < Values.Count; i++)
            {
                res = res * 31 + Values[i].GetHashCode();
            }
            return res;
        }
        ...
        public static ImmutableRangeList<TValue> operator ~(ImmutableRangeList<TValue> list)
        {
            return list.Invert();
        }

        public static ImmutableRangeList<TValue> operator +(
            ImmutableRangeList<TValue> list1, ImmutableRangeList<TValue> list2)
        {
            return list1.AddRange(list2);
        }

        public static ImmutableRangeList<TValue> operator -(
            ImmutableRangeList<TValue> list1, ImmutableRangeList<TValue> list2)
        {
            return list1.RemoveRange(list2);
        }
        ...
        public static ImmutableRangeList<TValue> operator !(
            ImmutableRangeList<TValue> list)
        {
            return list.Invert();
        }
