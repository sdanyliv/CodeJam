...
namespace CodeJam.Collections
{
	...
	public partial class ArrayExtensions
	{
		...
		/// </summary>
		[Pure]
		public static bool Equals<T>([CanBeNull] this T[] a, [CanBeNull] T[] b, [NotNull] IEqualityComparer<T> comparer)
		{
		...
		/// </summary>
		[Pure]
		public static bool Equals([CanBeNull] this int[] a, [CanBeNull] int[] b)
		{
			if (a == null && b == null)
				return true;
