	...
	public static class BenchmarkHelpers
	{
		...
		public static double Percentile(IEnumerable<double> values, double percentileRatio)
		{
			...
			if (percentileRatio < 0 || percentileRatio > 1)
				throw new ArgumentOutOfRangeException(nameof(percentileRatio), "The percentile arg should be in range of 0.0 - 1.0.");
			...
			Array.Sort(elements);
			var realIndex = percentileRatio*(elements.Length - 1);
