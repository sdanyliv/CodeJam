...
namespace BenchmarkDotNet.NUnit
{
	...
	/// </summary>
		...
		/// </summary>
		public static void Run<T>(double maxRatio) => RunCompetition(0, maxRatio, typeof (T), null, null);
		...
		private static void RunCompetitionUnderSetup(double minRatio, double maxRatio, Type benchType, string benchSource,
			IConfig config)
		{
